...
#define START_MASTERNODE_PAYMENTS_TESTNET 1470013200
#define START_MASTERNODE_PAYMENTS 1470013200
...
// Increasing the block payout to 2 NEOS per block, 1 per staker, 1 per MN
static const int64_t REWARD_FORK_BLOCK = 109000;
